    ...
    <form class="form-horizontal" action="meetingRoomBespeakServlet" method="post">
       ...
       <div class="form-group"> 
        ...
        <div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<input type="text"  readonly="readonly" onclick="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd HH:mm:ss '})"  name="stratTimeStr" id="stratTimeStr" placeholder="请输会议开始时间"  class="form-control" />
             </div>
        </div>
        <div class="form-group"> 
        	<label for="name" class="col-xs-2 control-label " > 结束时间</label>
            <div class="col-xs-4">
            	<input type="text"  readonly="readonly" onclick="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd HH:mm:ss '})" name="endTimeStr" id="endTimeStr" placeholder="请输会议结束时间"  class="form-control" />
             </div>
        </div>
        <div class="form-group"> 
